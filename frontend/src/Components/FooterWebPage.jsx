...
const FooterWebPage = () => {
  ...
  return (
    <div className="relative mt-44 sm:mt-44 md:mt-96 lg:mt-96 mediumLaptop:mt-96 xl:mt-96 2xl:mt-96 largestLaptop:mt-96">
      ...
      <footer className="relative py-8 px-6 text-white h-full drop-shadow-xl">
        ...
        >
          {/* Logo */}
          <div
            className="mb-4 sm:mb-4 md:mb-0 lg:mb-0 mediumLaptop:mb-0 xl:mb-0 2xl:mb-0 largestLaptop:mb-0 
           px-10 sm:px-10 md:px-24 lg:px-24 mediumLaptop:px-24 xl:px-24 2xl:px-24 largestLaptop:px-40"
          >
            <a href="/">
              <img
                src={ecgWhiteLogo}
                alt="ECG-Logo"
                className="h-32 sm:h-auto md:h-auto lg:h-auto mediumLaptop:h-auto xl:h-auto 2xl:h-auto largestLaptop:h-auto
                 w-auto sm:w-auto md:w-[23rem] lg:w-[23rem] mediumLaptop:w-[23rem] xl:w-[23rem] 2xl:w-[23rem] largestLaptop:w-[28rem] "
              />
            </a>
          </div>
