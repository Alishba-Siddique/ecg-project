...
//   return (
//     <div className="flex flex-col items-center justify-center min-h-screen bg-primary overflow-hidden -mb-10">
...
// const PreLoader = ({ handleImageLoaded }) => {
//   const [progress, setProgress] = useState(0);
...
const PreLoader = ({ progress }) => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-primary overflow-hidden -mb-10">
      ...
      {/* Text Animation and Loading Percentage */}
      <h1 className="mt-5 text-white text-4xl font-nudista font-bold tracking-widest animate-pulse">
